...
from account.views import (CreateMenuGrpView, UpdateMenuGrpView, UpdateMenuMasterView, CreateMenuMasterView,
...
urlpatterns = [
    ...
    path('usertaskaccessview/<int:pk>', UpdateUserTaskAccessView.as_view(),
         name='usertaskaccessviewupdate'),
    path('fieldmasterview/', CreateFieldMasterView.as_view(), name='fieldmasterview'),
    path('fieldmasterview/<int:pk>', UpdateFieldMasterView.as_view(),
